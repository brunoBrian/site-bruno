...
function registra_sidebar_mais_vistos(){
...
add_action( 'widgets_init', 'registra_sidebar_mais_vistos' );


function registra_widget_mais_vistos(){
    register_widget( 'registra_widget_mais_vistos' );
}
add_action( 'widgets_init', 'registra_widget_mais_vistos' );


class registra_widget_mais_vistos extends WP_Widget {

    function __construct() {
        parent:: __construct(
            'registra_widget_mais_vistos',
            'Mais Vistos',
            array( 'description' => 'Widget para exibir os mais vistos' )
        );
    }
